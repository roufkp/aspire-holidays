...
const Admin = () => {
  ...
  const testimonals = testimonails.map((e) => {
    return(
      ...
      <button onClick={() => handleItemClick(3)}>Edit</button>
     </div>)  
  });
...
const b = <div className={styles.fullScreen}> 
             <button  onClick ={() => {setSelectedBlog(null); handleItemClick(2)}} >Add</button>
             ...
             {selectedBlog ? (
              <div>
                 ...
                 <button onClick={() => handleItemClick(2)} >Edit session</button>
                 {/* {edit && <button onClick={() => history('/updateBlog/'+ blogInfo.uuid)}>Edit</button>} */}
               </div>
              ) : (
...
const c   =  <div className={styles.fullScreen}> 
              <>
              <button  onClick ={() => {setSelectedTestimonial(null); handleItemClick(3)}} >Add</button>
               {testimonals}                
              </>
              </div>;
  ...
  function handleItemClickedit(){
   ...
   return(
      ...
      <div className={styles.sectionContainer}>
        ...
        {activeSection === 3 && <UpdateTestimonial
